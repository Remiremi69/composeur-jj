// Noyau métier partagé — moteur de règles des étapes.
// 100 % piloté par les données de la table `steps` (rule_type / rule_min /
// rule_max), éventuellement surchargées par la formule (step_rules).
...
export interface RuleStatus {
  ...
  label: string // texte affiché ("8 / 12 pièces")
}
