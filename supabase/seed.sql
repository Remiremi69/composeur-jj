...
INSERT INTO "public"."options" ("id", "slug", "category", "name", "description", "price", "price_unit", "position", "is_active") VALUES
	...
	('2899c8aa-6d86-4b45-869d-c9193c31f562', 'dessert-buffet-gateaux', 'dessert', 'Présentation en buffet des gâteaux, avec les mariés', 'Tous les gâteaux dressés en buffet et dévoilés avec les mariés.', 0.00, 'par_personne', 7, true),
